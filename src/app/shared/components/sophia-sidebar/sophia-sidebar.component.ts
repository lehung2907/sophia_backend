...
import { sophiaSidebarHelperService } from "./sophia-sidebar-helper.service";

@Component({
  selector: "sophia-sidebar",
  templateUrl: "./sophia-sidebar.component.html",
  styleUrls: ["./sophia-sidebar.component.scss"]
})
export class sophiaSidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
  ...
  constructor(
    ...
    private sidebarHelperService: sophiaSidebarHelperService,
  ...
  showBackdrop() {
    ...
    this.backdrop.classList.add("sophia-sidebar-overlay");
...
@Directive({
  selector: "[sophiaSidebarToggler]"
})
export class sophiaSidebarTogglerDirective {
  @Input("sophiaSidebarToggler")
  public id: any;

  constructor(private sophiaSidebarHelperService: sophiaSidebarHelperService) {}

  @HostListener("click")
  onClick() {
    this.sophiaSidebarHelperService.getSidebar(this.id).toggle();
  }
}
