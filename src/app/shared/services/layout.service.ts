...
export interface ILayoutConf {
  ...
  matTheme?: string; // material theme. sophia-blue, sophia-navy, sophia-dark, sophia-dark-pink
  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "slate", // http://demos.ui-lib.com/sophia-doc/#sophia-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        dir: "ltr", // ltr, rtl
        useBreadcrumb: true,
        topbarFixed: false,
        footerFixed: false,
        topbarColor: "white", // http://demos.ui-lib.com/sophia-doc/#sophia-colors
        footerColor: "slate", // http://demos.ui-lib.com/sophia-doc/#sophia-colors
        matTheme: "sophia-blue", // sophia-blue, sophia-navy, sophia-light-purple, sophia-dark, sophia-dark-pink
