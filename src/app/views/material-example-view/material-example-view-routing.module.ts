...
import { sophiaExampleViewerTemplateComponent } from "app/shared/components/example-viewer-template/example-viewer-template.component";
import {
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: "",
        component: sophiaExampleViewerTemplateComponent,
        data: {
